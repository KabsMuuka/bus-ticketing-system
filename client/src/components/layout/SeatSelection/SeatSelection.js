              ...
              <form onChange={(e) => getSeatNumber(e)}>
                <ol className="cabin fuselage">
                  ...
                  <li className="row row--1">
                    <ol className="seats" type="A">
                      ...
                      <li className="seat">
                        ...
                        {/* <label htmlFor="1C">Driver</label> */}
                      </li>
                      <li className="seat">
                        <input type="checkbox" disabled value="1D" id="1D" />
                        <label htmlFor="1D">Driver</label>
                      </li>
                    </ol>
                  </li>
                  {/* row 2 */}
                  ...
                  <li className="row row--11">
                    <ol className="seats" type="A">
                      <li className="seat">
                        <input type="checkbox" value="11A" id="11A" />
                        <label htmlFor="11A">11A</label>
                      </li>
                      <li className="seat">
                        <input type="checkbox" value="11B" id="11B" />
                        <label htmlFor="11B">11B</label>
                      </li>
                      <li className="seat">
                        <input type="checkbox" value="11C" id="11C" />
                        <label htmlFor="11C">11C</label>
                      </li>
                      <li className="seat">
                        <input type="checkbox" value="11D" id="11D" />
                  ...
                  <li className="row row--12">
                    <ol className="seats" type="A">
                      <li className="seat">
                        <input type="checkbox" value="12A" id="12A" />
                        <label htmlFor="12A">12A</label>
                      </li>
                      <li className="seat">
                        <input type="checkbox" value="12B" id="12B" />
                        <label htmlFor="12B">12B</label>
                      </li>
                      <li className="seat">
                        <input type="checkbox" value="12C" id="12C" />
                        <label htmlFor="12C">12C</label>
                      </li>
                      <li className="seat">
                        <input type="checkbox" value="12D" id="12D" />
                  ...
                  <li className="row row--13">
                    <ol className="seats" type="A">
                      ...
                      <li className="seat">
                        <input type="checkbox" value="13B" id="13B" />
                        <label htmlFor="13B">13B</label>
                      </li>
                      <li className="seat">
                        <input type="checkbox" value="13C" id="13C" />
                        <label htmlFor="13C">13C</label>
                      </li>
                      <li className="seat">
                        <input type="checkbox" value="13D" id="13D" />
                        <label htmlFor="13D">13D</label>
                      </li>
                    </ol>
                  </li>
                </ol>
