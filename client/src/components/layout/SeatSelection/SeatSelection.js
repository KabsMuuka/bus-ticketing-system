...
import { storebus_firstBus } from "../../../actions/profile";
import { GetReservedSeats_firstBus } from "../../../actions/profile";
import "./Tab.css";
...
export default function SeatSelection() {
  ...
  useEffect(() => {
    dispatch(GetReservedSeats_firstBus());
    if (storedSeats) {
  ...
  console.log("firstBus", storedSeats);
  ...
  const getSeatNumber = (e) => {
    ...
    setArrowDown(true);
    dispatch(storebus_firstBus(newSeat)); // Store the selected seat
